...
class NexiToYNABTest extends TestCase
{
    public function test_process()
    {
        ...
        $this->assertEquals('33.88', $YNABTransactions->getByIndex(0)->getInflowAsString());
        $this->assertEquals('0.00', $YNABTransactions->getByIndex(0)->getOutflowAsString());
        ...
        $this->assertEquals('0.00', $YNABTransactions->getByIndex(1)->getInflowAsString());
        $this->assertEquals('53.25', $YNABTransactions->getByIndex(1)->getOutflowAsString());
        ...
        $this->assertEquals('1.71', $YNABTransactions->getByIndex(2)->getInflowAsString());
        $this->assertEquals('0.00', $YNABTransactions->getByIndex(2)->getOutflowAsString());
    }
}